...
<head>
    ...
    <title>Inscription approuvée - AjiKhdam</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Nous avons le plaisir de vous informer que votre inscription en tant que talent sur AjiKhdam a été <strong>approuvée</strong>.</p>
            <p>Vos documents d'identification ont été vérifiés avec succès. Vous pouvez désormais accéder à votre tableau de bord et commencer à postuler aux missions disponibles.</p>

            <div class="btn-container">
                <a href="{{ $dashboardUrl }}" class="btn">Accéder au tableau de bord</a>
            </div>

            <p style="font-size: 14px; color: #48848D; margin-bottom: 0;">Si vous avez des questions, n'hésitez pas à contacter notre équipe de support.</p>
        </div>
        <div class="footer">
